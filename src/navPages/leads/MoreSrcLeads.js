...
export default class MoreSrcLeads extends Component {
  constructor(props) {
    super(props);
    this.state = {
        show: false
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' ,  textAlign:'center'}}>Contact </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' ,  textAlign:'center'}}>Company </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' , textAlign:'center'}}>Select contact from list... </Text>
</View>
    </TouchableOpacity>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' , textAlign:'center'}}>Select company from list... </Text>
</View>
    </TouchableOpacity>
