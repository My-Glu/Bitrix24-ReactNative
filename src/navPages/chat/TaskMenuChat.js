...
export default class TaskMenuChat extends Component {
  constructor(props) {
    super(props);
    this.state = {
        show: false
...
{/* {this.renderTitle} */}
 <View style={{justifyContent: 'center'}}>
    ...
    onPress={onShowPopupMenu}
     > 
<View style={{flexDirection: 'row', justifyContent: 'flex-start', marginTop: '10%', marginLeft:'15%',}}>
<Image source={require('../../assets/images/addtask.png') } style={{width:20, height:20}}  />


<Text style={{color:'#49641D', fontSize:16, fontWeight:'500' , marginLeft:'10%', textAlign:'center'}}>Create task </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:16, fontWeight:'500' , marginLeft:'10%', textAlign:'center'}}>Discuss in Activity Stream </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:16, fontWeight:'500' , marginLeft:'10%', textAlign:'center'}}>Discuss in a chat </Text>
</View>
    </TouchableOpacity>
