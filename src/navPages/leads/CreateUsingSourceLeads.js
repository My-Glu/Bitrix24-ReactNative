...
import MoreSrcLeads from './MoreSrcLeads'

const deviceHeight = Dimensions.get('window').height
const deviceWidth = Dimensions.get('window').width

export default class CreateUsingSourceLeads extends Component {
  constructor(props) {
    super(props);
    this.state = {
        show: false
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' ,  textAlign:'center'}}>Deal + Contact + Company </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' , textAlign:'center'}}>Deal + Contact </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' ,  textAlign:'center'}}>Deal + Company </Text>
</View>
    </TouchableOpacity>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' ,  textAlign:'center'}}>Deal </Text>
</View>
...
<Text style={{color:'#49641D', fontSize:18, fontWeight:'500' , textAlign:'center'}}>Contact + Company </Text>
</View>
    </TouchableOpacity>
    <TouchableOpacity>
