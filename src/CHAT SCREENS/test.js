    ...
    renderInner = () => (
        ...
        <View style={styles.panel}>
            ...
            <View style={{flexDirection: 'row',marginBottom:15 ,alignItems:'center',borderBottomColor:'grey',borderBottomWidth:1,borderBottomEndRadius:100,borderBottomStartRadius:100}}>
                <Avatar.Image size={24} source={require('../assets/blue6.jpg')} size={65} />
      ...
      renderHeader = () => (
            ...
            <View style={styles.bottomHeader}>
                <View style={styles.panelHeader}>
                    <View style={styles.panelHandle}><Text style={{ fontSize: 18, color: 'green' }}>New Chat</Text></View>
                </View>
            </View>
      );
    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View style={{marginTop: 180, marginLeft: 280}}>
                    <TouchableOpacity delayPressIn={1} onPress={() => this.bs.current.snapTo(0)}>
                        <Image source={require('../assets/plusicon.png')} style={{ height: 60, width: 60 }} />
                    </TouchableOpacity>
